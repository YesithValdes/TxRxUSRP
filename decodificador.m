...
filename = 'imagen_color_bits_formato_101_lineas.txt';  % Archivo original con cadenas largas
...
if isempty(cadena_valida)
    error('⚠ No se encontró ninguna cadena válida con 30 "a", 30 "b" y 78780 caracteres.');
end
...
if ~all(mascara_binaria)
    ...
    fprintf('⚠ Se detectaron %d caracteres no binarios. Serán reemplazados por ''0''.\n', num_corruptos);
...
title('🖼 Imagen Color Reconstruida desde archivo TXT');
